...
class CompanyEncode{
	...
	function CompanyEncode($http_post_vars,$companyID="",$formAction="",$sess,$ownerID="",$odID,$locID,$parentURL){
		$this->sess = $sess;
...
//*/
$companyEncode = new CompanyEncode($HTTP_POST_VARS,$companyID,$formAction,$sess,$ownerID,$odID,$locID,$parentURL);
$companyEncode->main();
?>
