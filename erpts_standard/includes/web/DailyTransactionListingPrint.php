...
#####################################
class DailyTransactionListingPrint{
	
	var $tpl;
	var $formArray;
	var $sess;

	function DailyTransactionListingPrint($http_post_vars,$sess,$formAction,$formArray,$page=1){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "DailyTransactionListingPrint.htm") ;
...
$dailyTransactionListingPrint = new DailyTransactionListingPrint($HTTP_POST_VARS,$sess,$formAction,$formArray,$page);
$dailyTransactionListingPrint->main();
?>
<?php page_close(); ?>
