...
#####################################
class CalculateRPTOP{
	
	var $tpl;
	var $formArray;
	var $sess;
	
	function CalculateRPTOP($http_post_vars,$sess,$rptopID,$page,$searchKey,$formAction,$sortBy,$sortOrder){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "CalculateRPTOP.htm") ;
...
if(!$page) $page = 1;
$calculateRPTOP = new CalculateRPTOP($HTTP_POST_VARS,$sess,$rptopID,$page,$searchKey,$formAction,$sortBy,$sortOrder);
$calculateRPTOP->main();
?>
<?php page_close(); ?>
