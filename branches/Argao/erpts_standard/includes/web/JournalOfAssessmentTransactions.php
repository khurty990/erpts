...
#####################################
class JournalOfAssessmentTransactions{
	
	var $tpl;
	function JournalOfAssessmentTransactions($sess){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "JournalOfAssessmentTransactions.htm") ;
...
//*/
$journalOfAssessmentTransactions = new JournalOfAssessmentTransactions($sess);
$journalOfAssessmentTransactions->Main();
?>
<?php page_close(); ?>
