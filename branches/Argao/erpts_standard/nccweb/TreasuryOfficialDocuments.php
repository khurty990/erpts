...
#####################################
class TreasuryOfficialDocuments{
	
	var $tpl;
	function TreasuryOfficialDocuments($sess){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "TreasuryOfficialDocuments.htm") ;
		$this->tpl->set_var("TITLE", "TM : Treasury Official Documents");
	}
...
//*/
$treasuryOfficialDocuments = new TreasuryOfficialDocuments($sess);
$treasuryOfficialDocuments->main();
?>
<?php page_close(); ?>
