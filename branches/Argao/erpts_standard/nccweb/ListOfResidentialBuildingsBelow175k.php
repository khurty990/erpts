...
#####################################
class ListOfResidentialBuildingsBelow175k{
	
	var $tpl;
	function ListOfResidentialBuildingsBelow175k($sess){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "ListOfResidentialBuildingsBelow175k.htm") ;
		$this->tpl->set_var("TITLE", "List of Residential Buildings with Market Value below Php 175,000");
	}
	...
	function Main(){
		...
		$this->tpl->set_var("totalCount", $count);
...
//*/
$ListOfResidentialBuildingsBelow175k = new ListOfResidentialBuildingsBelow175k($sess);
$ListOfResidentialBuildingsBelow175k->Main();
?>
<?php page_close(); ?>
