...
#####################################
class TreasuryReports{
	
	var $tpl;
	function TreasuryReports($sess){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "TreasuryReports.htm") ;
...
//*/
$treasuryReports = new TreasuryReports($sess);
$treasuryReports->main();
?>
<?php page_close(); ?>
