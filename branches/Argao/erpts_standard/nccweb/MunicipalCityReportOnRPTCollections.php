...
#####################################
class MunicipalCityReportOnRPTCollections{
	
	var $tpl;
	function MunicipalCityReportOnRPTCollections($sess){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "MunicipalCityReportOnRPTCollections.htm") ;
		$this->tpl->set_var("TITLE", "TM : Municipal/City Report On Real Property Tax Collections");
	}
...
//*/
$municipalCityReportOnRPTCollections = new MunicipalCityReportOnRPTCollections($sess);
$municipalCityReportOnRPTCollections->Main();
?>
<?php page_close(); ?>
