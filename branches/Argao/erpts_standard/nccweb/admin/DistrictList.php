...
class DistrictList{
	...
	var $tpl;
	var $formArray;
	function DistrictList($http_post_vars,$sess,$sortBy,$sortOrder,$hideInactive){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "DistrictList.htm") ;
...
//*/
$districtList = new DistrictList($HTTP_POST_VARS,$sess,$sortBy,$sortOrder,$hideInactive);
$districtList->Main();
?>
<?php page_close(); ?>
