...
#####################################
class MergeOwnerCompanyConfirm{
	
	var $tpl;
	function MergeOwnerCompanyConfirm($sess,$http_post_vars){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "MergeOwnerCompanyConfirm.htm") ;
...
//*/
$obj = new MergeOwnerCompanyConfirm($sess,$HTTP_POST_VARS);
$obj->Main();
?>
<?php page_close(); ?>
