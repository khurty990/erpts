...
#####################################
class ListOfPropertyByClassification{
	
	var $tpl;
	function ListOfPropertyByClassification($sess){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "ListOfPropertyByClassification.htm") ;
...
//*/
$listOfPropertyByClassification = new ListOfPropertyByClassification($sess);
$listOfPropertyByClassification->Main();
?>
<?php page_close(); ?>
