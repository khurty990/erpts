...
#####################################
class ChartsAndGraphs{
	
	var $tpl;
	function ChartsAndGraphs($sess){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "ChartsAndGraphs.htm") ;
		$this->tpl->set_var("TITLE", "TM : Charts and Graphs");
	}
...
//*/
$chartsAndGraphs = new ChartsAndGraphs($sess);
$chartsAndGraphs->main();
?>
<?php page_close(); ?>
