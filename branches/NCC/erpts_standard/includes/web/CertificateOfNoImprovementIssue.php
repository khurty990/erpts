...
#####################################
class CertificateOfNoImprovementIssue{
	
	var $tpl;
	function CertificateOfNoImprovementIssue($http_post_vars,$formArray,$formAction,$searchKey,$page,$sess){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "CertificateOfNoImprovementIssue.htm") ;
...
$obj = new CertificateOfNoImprovementIssue($HTTP_POST_VARS,$formArray,$formAction,$searchKey,$page,$sess);
$obj->Main();
?>
<?php page_close(); ?>
