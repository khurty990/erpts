...
class AFSDetails{
	...
	function AFSDetails($http_post_vars,$sess,$afsID,$type="",$transactionCode=""){
		global $auth;
		...
		$this->tpl->set_var("TITLE", "Reassessment > FAAS / TD Details");
		...
		if($this->formArray["transactionCodeDone"]!=""){
			$this->formArray["transactionCodeDoneMsg"] = "This property is set for reassessment with transaction code: <b>" . $this->formArray["transactionCodeDone"] . "</b>.<br> Please fill up the necessary fields with their new values.";
		}
		else{
