...
class TDDetails{
	...
	function formatCurrency1($key){
		...
		$this->formArray[$key] = number_format($this->formArray[$key], 2, ".", ",");
	        ...
	        function formatCurrency2($key){
                if($this->formArray[$key]=="")
                        return false;
                $this->formArray[$key] = number_format($this->formArray[$key], 0, ".", ",");
        }
	...
	function setForm(){
		...
		//end
		$this->formatCurrency2("propertyAssessmentLevel1");
		$this->formatCurrency2("propertyAssessmentLevel2");
		$this->formatCurrency2("propertyAssessmentLevel3");
		$this->formatCurrency2("propertyAssessmentLevel4");
...
//			$adjsumm = "[".number_format($adjperc,2) . "[" . number_format($lTotalValueAdjustment,2);
	...
	//AKO DUGANG CODE to display administrator address in buildings
	...
	if (is_a($improvementsBuildings->propertyAdministrator,Person)){
		...
		if(is_array($improvementsBuildings->propertyAdministrator->addressArray)){
	$adminAddress = $improvementsBuildings->propertyAdministrator->addressArray[0]->getNumber();
	$adminAddress.= " ".$improvementsBuildings->propertyAdministrator->addressArray[0]->getStreet();
	$adminAddress.= " ".$improvementsBuildings->propertyAdministrator->addressArray[0]->getBarangay();
	$adminAddress.= " ".$improvementsBuildings->propertyAdministrator->addressArray[0]->getDistrict();
	$adminAddress.= " ".$improvementsBuildings->propertyAdministrator->addressArray[0]->getMunicipalityCity();
	$adminAddress.= " ".$improvementsBuildings->propertyAdministrator->addressArray[0]->getProvince();
			$this->formArray["adminAddress"] = $adminAddress;
					}
				}			
	//*********************END
				...
				//$this->formArray["bFloorArea".($i+1)] = 
$improvementsBuildings->getAreaOfGroundFloor();
				...
				//$nBuildingsTotalArea +=toFloat($improvementsBuildings->getTotalBuildingArea());
                                //$this->formArray["unit"] = $improvementsBuildings->getUnit();
				}
				$nFindingsTotalArea +=toFloat($improvementsBuildings->getTotalBuildingArea());
                                //$this->formArray["unit"] = $improvementsBuildings->getUnit();
...
// ako dugang code to display administrator address
	if (is_a($machineries->propertyAdministrator,Person)){
	
	 $this->formArray["administrator"] = $machineries->propertyAdministrator->getFullName();
	     if (is_array($machineries->propertyAdministrator->addressArray)){
	     $adminAddress = $machineries->propertyAdministrator->addressArray[0]->getNumber();
	     $adminAddress.=" ".$machineries->propertyAdministrator->addressArray[0]->getStreet();
	     $adminAddress.=" ".$machineries->propertyAdministrator->addressArray[0]->getBarangay();
	     $adminAddress.=" ".$machineries->propertyAdministrator->addressArray[0]->getDistrict();
	     $adminAddress.=" ".$machineries->propertyAdministrator->addressArray[0]->getMunicipalityCity();
	     $adminAddress.=" ".$machineries->propertyAdministrator->addressArray[0]->getProvince();
	     $this->formArray["adminAddress"] = $adminAddress;
	     }
	     }
//end of my code.  2/28/2008"] = $	     
