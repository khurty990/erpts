...
#####################################
class ListOfPropertiesForAuction{
	
	var $tpl;
	function ListOfPropertiesForAuction($sess){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "ListOfPropertiesForAuction.htm") ;
...
//*/
$listOfPropertiesForAuction = new ListOfPropertiesForAuction($sess);
$listOfPropertiesForAuction->Main();
?>
<?php page_close(); ?>
