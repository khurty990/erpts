...
class ODDetails{
	...
	function ODDetails($http_post_vars,$sess,$odID,$transactionCode=""){
		...
		if($this->formArray["transactionCodeDone"]!=""){
			$this->formArray["transactionCodeDoneMsg"] = "This property has been marked with transaction code: <b>" . $this->formArray["transactionCodeDone"] . "</b>.<br>You may update the names of the owner as well as other property information now.";
		}
		else{
