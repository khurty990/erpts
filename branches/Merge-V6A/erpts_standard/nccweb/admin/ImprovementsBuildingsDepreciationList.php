...
class ImprovementsBuildingsDepreciationList{
	...
	var $tpl;
	var $formArray;
	function ImprovementsBuildingsDepreciationList($http_post_vars,$sess,$sortBy,$sortOrder,$hideInactive){
		global $auth;
		...
		$this->tpl->set_file("rptsTemplate", "ImprovementsBuildingsDepreciationList.htm") ;
	...
	function showHideInactive(){
		...
		switch($this->formArray["hideInactive"]){
			...
			default:
				...
				$condition = " WHERE ".IMPROVEMENTSBUILDINGS_DEPRECIATION_TABLE.".status='active' ";
				break;
		}
		return $condition;
	}
...
//*/
$improvementsBuildingsDepreciationList = new ImprovementsBuildingsDepreciationList($HTTP_POST_VARS,$sess,$sortBy,$sortOrder,$hideInactive);
