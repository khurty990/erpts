...
#####################################
class MunicipalCityReportOnRPTCollectionsPrint{
	
	var $tpl;
	var $formArray;

	function MunicipalCityReportOnRPTCollectionsPrint($http_post_vars,$sess){
		$this->sess = $sess;
		$this->tpl = new rpts_Template(getcwd(),"keep");

		$this->tpl->set_file("rptsTemplate", "reports2B2c.xml") ;
		$this->tpl->set_var("TITLE", "Municipal/City Report on Real Property Tax Collections");
...
$municipalCityReportOnRPTCollectionsPrint = new MunicipalCityReportOnRPTCollectionsPrint($HTTP_POST_VARS,$sess);
$municipalCityReportOnRPTCollectionsPrint->Main();
?>
<?php page_close(); ?>